"""
https://www.kaggle.com/vaheed/avito-duplicate-ads-detection/logistict-regression/output

Vahid: Logistic Regression

Leaderboard: 0.64128, ignoring locationID, metroID, categoryID, attrsJSON, and image contents
...
trainInfo = pd.read_csv("../data/ItemInfo_train.csv")
trainInfo = trainInfo.drop(['locationID', 'metroID', 'categoryID', 'attrsJSON'], axis = 1)
train = pd.read_csv("../data/ItemPairs_train.csv")
...
testInfo =  pd.read_csv("../data/ItemInfo_test.csv")
testInfo = testInfo.drop(['locationID', 'metroID', 'categoryID', 'attrsJSON'], axis = 1)
test  = pd.read_csv("../data/ItemPairs_test.csv")
